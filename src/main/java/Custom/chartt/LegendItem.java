...
public class LegendItem extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbColor = new Custom.chartt.LabelColor();

        lbName.setForeground(new java.awt.Color(100, 100, 100));
        lbName.setText("Name");

        lbColor.setBackground(new java.awt.Color(102, 204, 255));
        lbColor.setForeground(new java.awt.Color(102, 153, 255));
    ...
    private Custom.chartt.LabelColor lbColor;
